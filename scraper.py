...
class EbayScraper:
    ...
    def get_desc(self):
        url = 'https://vi.vipr.ebaydesc.com/ws/eBayISAPI.dll?ViewItemDescV4&item=225625920147&t=0&category=145944&seller=uakin50&vipguid=c7d6a3d01890a647e2048119fffd68d6&excTrk=1&tto=3500&lsite=0&ittenable=false&domain=ebay.com&descgauge=1&cspheader=1&oneClk=2&secureDesc=1'
